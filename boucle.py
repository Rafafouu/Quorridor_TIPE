...
plateau = Plateau(dim)
j1 = ASLOpenSpacesBot(plateau.board[dim-1][dim // 2], [case for case in plateau.board[0]], plateau, 8) #ROUGE
j2 = ASGigaSmartBot(plateau.board[0][dim // 2], [case for case in plateau.board[dim-1]], plateau, 5) #BLEU
